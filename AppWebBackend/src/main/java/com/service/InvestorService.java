...
public class InvestorService {
	...
	private WatchListDao watckListDao = new WatchListDao();
	// http://locallhost:8080/AppWebBackend/service/investor/findall
	@Path("/findall")
	@GET
	...
	public Investor getInvestor(@PathParam("id") Integer id) {
		...
		List<WatchList> watchLists =watckListDao.queryByInvestorId(id);
